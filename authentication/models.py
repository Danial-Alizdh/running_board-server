...
class DepartmentNews(models.Model):
    ...
    image = models.ImageField(verbose_name="عکس", upload_to='uploads/news')
    ...
    class Meta:
        verbose_name_plural = "اخبار هیئت دوومیدانی"
        verbose_name = "خبر هیئت دوومیدانی"
...
class UserProfile(models.Model):
    ...
    image_profile = models.ImageField(verbose_name="تصویر پروفایل", upload_to='uploads/profile_pics', null=True, blank=True)
    ...
    hasCredit = models.BooleanField(verbose_name="پرداخت شده", default=False)
...
class Coach(models.Model):
    ...
    document_image = models.ImageField(verbose_name="تصویر کارت مربی‌گری", upload_to='uploads/lisense_pics',
...
class GymManager(models.Model):
    ...
    image = models.ImageField(verbose_name="تصویر باشگاه", upload_to='uploads/gym_place', null=True, blank=True)
    document_image = models.ImageField(verbose_name="تصویر پروانه", upload_to='uploads/lisense_pics', null=True,
                                       blank=True)
...
class Actor(models.Model):
    user = models.OneToOneField(UserProfile, on_delete=models.CASCADE)
    document_image = models.ImageField(verbose_name="تصویر حکم قهرمانی", upload_to='uploads/lisense_pics',
                                       null=True, blank=True)
...
class BoardGame(models.Model):
    ...
    image = models.ImageField(verbose_name="تصویر", upload_to='uploads/games', null=True, blank=True)
    date = models.CharField(verbose_name='تاریخ برگزاری', null=False, max_length=10)
