"""
Django settings for running_board project.
...
ALLOWED_HOSTS = ['*', 'running_board-server.onrender.com']
...
ROOT_URLCONF = 'running_board.urls'
...
WSGI_APPLICATION = 'running_board.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'running_board_db',
        'USER': 'AA',
        'PASSWORD': 'AA',
        'HOST': '127.0.0.1',
        'PORT': '5432',
